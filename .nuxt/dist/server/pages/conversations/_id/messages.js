...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/conversations/_id/messages.vue?vue&type=template&id=f5e5324c&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-container',[_c('v-row',[_c('v-col',[_vm._v("\n      Messages for conversation #"+_vm._s(this.$route.params.id)+"\n      "),_c('br'),_vm._v(" "),_c('br'),_vm._v(" "),_vm._l((_vm.messages),function(message){return _c('v-card',{key:message.id,staticClass:"mb-2 pa-4"},[_c('h3',{staticClass:"mb-2"},[_vm._v(_vm._s(message.username))]),_vm._v(" "),_c('hr'),_vm._v(" "),_c('p',{staticClass:"mt-2"},[_vm._v(_vm._s(message.message))]),_vm._v(" "),_c('small',[_vm._v(_vm._s(message.created_at))])])})],2)],1)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/conversations/_id/messages.vue?vue&type=template&id=f5e5324c&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/conversations/_id/messages.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var messagesvue_type_script_lang_js_ = ({
  ...
  methods: {
    async getMessages() {
      fetch(`/api/conversations/${this.$route.params.id}/messages`).then(response => response.json()).then(data => {
        console.log(data);
...
// CONCATENATED MODULE: ./pages/conversations/_id/messages.vue?vue&type=script&lang=js&
 /* harmony default export */ var _id_messagesvue_type_script_lang_js_ = (messagesvue_type_script_lang_js_); 
...
// CONCATENATED MODULE: ./pages/conversations/_id/messages.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  _id_messagesvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
